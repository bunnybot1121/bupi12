...
document.addEventListener('DOMContentLoaded', function() {
  ...
  if (anniversaryEl) {
    const relationshipStart = new Date('2024-11-29'); // Updated relationship start date as requested
    ...
    anniversaryEl.innerHTML = `
      ...
      <div style="margin-top: 10px; font-style: italic; font-weight: 600; color: #e0e0ff;">
        The most precious gift is received is you
      </div>
    `;
  }
});
